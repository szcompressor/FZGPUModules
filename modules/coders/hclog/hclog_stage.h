...
public:
    ...
    // Byte-word 16 KB shape only — matches the fused HCLOGCoder device op
    // (d_HCLOG<uint8_t, 16384>, identical to word_size==1 execute()).
    ...
    FusedOpDecl getFusedOp() const override {
        ...
        return FusedOpDecl{FusionStrategy::ChunkCooperative, "HCLOGCoder",
