...
__global__ void KERNEL_CUHIP_Huffman_ReVISIT_lite(
    E* in_data, size_t const len, Hf* hf_book, const uint32_t runtime_bklen, uint32_t* hf_bitstream,
    uint32_t* hf_bits, uint32_t* hf_cells, const uint32_t nblock, /* breaking handling */
...
#pragma unroll
  ...
  __shared__ uint32_t s_bitcount[NumThreads * 2];  // !!!! check types E and Hf
