...
// Configure the shared LorenzoQuant front-end.
static LorenzoQuantStage<float, uint16_t>* add_lorenzo_quant(
    Pipeline& p, float eb, size_t dim_x, size_t dim_y)
{
