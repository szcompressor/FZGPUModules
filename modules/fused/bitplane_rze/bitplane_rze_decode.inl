// Fused bitplane-transpose + zero-byte run-length DECODE kernel.
//
// Prior work: this kernel is the FZ-GPU lossless decoder. It is adapted from
// `KERNEL_CUHIP_fz_fused_decode` in the cuSZ/FZ-GPU codebase.
